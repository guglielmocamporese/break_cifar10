...
from datasets.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
...
@register_model
def vit_small_patch64_224(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        patch_size=64, embed_dim=768, depth=8, num_heads=8, mlp_ratio=3.,
